 ...
 */
public class Telescope2ImplHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public Telescope2ImplHelper(Logger containerLogger)
	{
