...
import alma.ASTAR_MODULE.AstarPOATie;
import alma.ASTAR_MODULE.AstarImpl.AstarImpl;
 ...
 * <p>
 * Name="ASTAR_1" Code="alma.ASTAR_MODULE.AstarImpl.AstarHelper" Type="IDL:alma/ASTAR_MODULE/Astar:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class AstarHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public AstarHelper(Logger containerLogger)
	{
