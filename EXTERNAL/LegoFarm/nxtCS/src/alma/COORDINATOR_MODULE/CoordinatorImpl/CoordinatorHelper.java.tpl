...
import alma.COORDINATOR_MODULE.CoordinatorPOATie;
import alma.COORDINATOR_MODULE.CoordinatorImpl.CoordinatorImpl;
 ...
 * <p>
 * Name="COORDINATOR_1" Code="alma.COORDINATOR_MODULE.CoordinatorImpl.CoordinatorHelper" Type="IDL:alma/COORDINATOR_MODULE/Coordinator:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class CoordinatorHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CoordinatorHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return CoordinatorPOATie.class;
	}
	...
	*/
	...
	{
		return CoordinatorOperations.class;
	}
