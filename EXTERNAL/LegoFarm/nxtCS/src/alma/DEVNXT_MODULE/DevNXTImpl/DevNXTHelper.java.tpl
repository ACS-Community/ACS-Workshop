...
package alma.DEVNXT_MODULE.DevNXTImpl;
...
import alma.DEVNXT_MODULE.DevNXTOperations;
import alma.DEVNXT_MODULE.DevNXTPOATie;
import alma.DEVNXT_MODULE.DevNXTImpl.DevNXTImpl;
 ...
 * <p>
 * Name="DEVNXT_1" Code="alma.DEVNXT_MODULE.DevNXTImpl.DevNXTHelper" Type="IDL:alma/DEVNXT_MODULE/DevNXT:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class DevNXTHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public DevNXTHelper(Logger containerLogger)
	{
