...
#ifndef __BLUECOMM_H__
#define __BLUECOMM_H__

#include "exceptions.h"
#include "comms.h"

class BlueComm:public Comms{
    private:
        int dev_id, local_sock, remote_sock;
    ...
    public:
        ...
        void connectByName(const char* name);
        void disconnect();
