 ...
 */
class Scheduler: public virtual acscomponent::ACSComponentImpl,     //Component superclass
		 public POA_SCHEDULER_MODULE::Scheduler    //CORBA servant stub
{    
  public:
    /**
     * Constructor
    ...
    class SchedulerThread : public ACS::Thread
    {
			...
			ACS::Thread(name)
		{
    		...
    		virtual ~SchedulerThread() { ACS_TRACE("SchedulerThread::~SchedulerThread"); }
