...
import alma.INSTRUMENT_MODULE.InstrumentOperations;
import alma.INSTRUMENT_MODULE.InstrumentPOATie;
import alma.INSTRUMENT_MODULE.InstrumentImpl.InstrumentImpl;
 ...
 * <p>
 * Name="INSTRUMENT_1" Code="alma.INSTRUMENT_MODULE.InstrumentImpl.InstrumentHelper" Type="IDL:alma/INSTRUMENT_MODULE/Instrument:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class InstrumentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public InstrumentHelper(Logger containerLogger)
	{
