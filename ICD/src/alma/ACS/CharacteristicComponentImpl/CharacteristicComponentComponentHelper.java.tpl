...
package alma.ACS.CharacteristicComponentImpl;
...
import alma.ACS.CharacteristicComponentPOATie;
import alma.ACS.CharacteristicComponentImpl.CharacteristicComponentImpl;
 ...
 */
public class CharacteristicComponentComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CharacteristicComponentComponentHelper(Logger containerLogger)
	{
	...
	*/
	...
	{
		return new CharacteristicComponentImpl();
	}
	...
	*/
	...
	{
		return CharacteristicComponentPOATie.class;
	}
	...
	*/
	...
	{
		return CharacteristicComponentOperations.class;
	}
