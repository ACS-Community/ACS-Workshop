...
package acsws.STORAGE_MODULE.StorageImpl;
...
import acsws.STORAGE_MODULE.StorageImpl.StorageImpl;
 ...
 * <p>
 * Name="STORAGE_1" Code="acsws.STORAGE_MODULE.StorageImpl.StorageComponentHelper" Type="IDL:acsws/STORAGE_MODULE/Storage:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class StorageComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public StorageComponentHelper(Logger containerLogger)
	{
