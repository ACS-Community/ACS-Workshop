...
import acsws.DATABASE_MODULE.DataBaseImpl.DataBaseImpl;
 ...
 * <p>
 * Name="DATABASE_1" Code="acsws.DATABASE_MODULE.DataBaseImpl.DataBaseComponentHelper" Type="IDL:acsws/DATABASE_MODULE/DataBase:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
