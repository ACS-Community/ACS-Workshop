...
package acsws.CAMERA_MODULE.CameraImpl;
...
import acsws.CAMERA_MODULE.CameraOperations;
import acsws.CAMERA_MODULE.CameraPOATie;
import acsws.CAMERA_MODULE.CameraImpl.CameraImpl;
 ...
 * <p>
 * Name="CAMERA_1" Code="acsws.CAMERA_MODULE.CameraImpl.CameraComponentHelper" Type="IDL:acsws/CAMERA_MODULE/Camera:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class CameraComponentHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public CameraComponentHelper(Logger containerLogger)
	{
