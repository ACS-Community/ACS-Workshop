...
import acsws.SCHEDULER_MODULE.SchedulerImpl.SchedulerImpl;
 ...
 * <p>
 * Name="SCHEDULER_1" Code="acsws.SCHEDULER_MODULE.SchedulerImpl.SchedulerComponentHelper" Type="IDL:acsws/SCHEDULER_MODULE/Scheduler:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
