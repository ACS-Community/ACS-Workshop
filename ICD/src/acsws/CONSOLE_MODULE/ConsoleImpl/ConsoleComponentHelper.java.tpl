...
import acsws.CONSOLE_MODULE.ConsoleImpl.ConsoleImpl;
 ...
 * <p>
 * Name="CONSOLE_1" Code="acsws.CONSOLE_MODULE.ConsoleImpl.ConsoleComponentHelper" Type="IDL:acsws/CONSOLE_MODULE/Console:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
