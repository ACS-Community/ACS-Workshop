...
import acsws.TELESCOPE_MODULE.TelescopePOATie;
 ...
 * <p>
 * Name="TELESCOPE_1" Code="acsws.TELESCOPE_MODULE.TelescopeImpl.TelescopeComponentHelper" Type="IDL:acsws/TELESCOPE_MODULE/Telescope:1.0" Container="frodoContainer" ImplLang="java"
 * <p>
