...
import alma.CONSOLE_MODULE.ConsolePOATie;
import alma.CONSOLE_MODULE.ConsoleImpl.ConsoleImpl;
 ...
 * <p>
 * Name="CONSOLE_1" Code="alma.CONSOLE_MODULE.ConsoleImpl.ConsoleHelper" Type="IDL:alma/CONSOLE_MODULE/Console:1.0" Container="frodoContainer"
 * <p>
 * @author alma-component-helper-generator-tool
 */
public class ConsoleHelper extends ComponentHelper
{
	/**
	 * Constructor
	 * @param containerLogger logger used only by the parent class.
	 */
	public ConsoleHelper(Logger containerLogger)
	{
