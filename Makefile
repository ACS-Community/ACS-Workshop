...
# ALMA Project
#
# "@(#) $Id: Makefile,v 1.9 2010-11-19 17:01:16 its Exp $"
#
# Makefile of ........
#
# who       when      what
...
SUBSYSTEM = SORT (UOS v3.0)

MODULES =  ICD EXTERNAL/scarletport EXTERNAL/Nexstar EXTERNAL/lpi \
		   console Database instrument ITS lego Nexstar scheduler

MODULES_TEST = console Database instrument scheduler Nexstar lego
