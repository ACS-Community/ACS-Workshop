...
MODULES = ICD EXTERNAL/SimNexstar EXTERNAL/SimLpi EXTERNAL/DATABASE EXTERNAL/INSTRUMENT TELESCOPE SCHEDULER \
		  ITS

TEST_MODULES = TELESCOPE SCHEDULER
...
$(Test):
	...
	@for member in $(foreach name,$(TEST_MODULES),$(name)); do\
