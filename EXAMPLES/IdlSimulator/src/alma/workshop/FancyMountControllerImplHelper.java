...
public class FancyMountControllerImplHelper extends ComponentHelper {

	public FancyMountControllerImplHelper(Logger containerLogger) {
	...
	protected ComponentLifecycle _createComponentImpl()
		...
		return new FancyMountControllerImpl();
	}

	@Override
	protected Class<? extends Servant> _getPOATieClass() {
		return FancyMountControllerPOATie.class;
	}

	@Override
	protected Class<? extends ACSComponentOperations> _getOperationsInterface() {
		return FancyMountControllerOperations.class;
	}
